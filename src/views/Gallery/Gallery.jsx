    ...
    <div className={styles.main}>
      ...
      {selectedImage && (
        <div className={styles.fullscreen}>
          ...
          <i title='imagen anterior' className={`${styles.prev} bx bxs-left-arrow`} onClick={handlePrevImage} />
          <i title='siguiente imagen' className={`${styles.next} bx bxs-right-arrow`} onClick={handleNextImage} />
          <i title='cerrar imagen' className={`${styles.close} bx bx-window-close`} onClick={handleCloseImage} />
        </div>
      )}
    </div>
  )
